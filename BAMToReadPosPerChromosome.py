...
def main(argv):
    ...
    if len(argv) < 3:
        print 'usage: python %s BAMfilename chrom.sizes outputfile_prefix [-nomulti] [-mismatchesMD M] [-mismatches M] [-readLength min max] [-chr chrN1(,chrN2....)] [-uniqueBAM] [-noNH samtools]' % argv[0]
